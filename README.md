...
![Project settings](Assets/project_settings_manual.png)
...
class_name | String | Set the name of the class. This is only applicable if you do not run Natrium from CocoaPods
